...
#from orders.models.customer import Product
...
class TestOrderService(unittest.TestCase):
    def setUp(self):
        #self.customer = Product(id=1, product_number="123",
                         # description="desc", unit_cost=1.00)
        self.address = Address(id=1, order_number="456",
                           customer=self.customer, quantity=1, total=1.00)
    ...
    def test_add_new_order(self):
        self.product_repository.get_by_id = Mock(return_value=self.customer)
